  ...
  return (
    <section className='cardService'>
      <div className='text-center py-6 rounded-2xl cursor-pointer ease-in-duration-200  mr-1 ml-1 duration-700'>
        ...
        <p className='font-bold text-2xl text-white hover:text-red-600 border border-white bg-black hover:bg-zinc-800 rounded-lg py-2 px-4  decoration-solid w-9/12 mx-auto my-auto text-center duration-[1200ms] text-lato'>Ver {butonText}</p>
      </div>
    </section>
  );
};
